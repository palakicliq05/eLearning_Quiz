odoo.define('elearning_quiz.survey_form_inherit', function (require) {
    'use strict';
    ...
    publicWidget.registry.SurveyFormWidget = publicWidget.Widget.extend({
        ...
        */
        _prepareSubmitValues: function (formData, params) {
            ...
            this.$('[data-question-type]').each(function (formData1) {
                switch ($(this).data('questionType')) {
                    ...
                    case 'numerical_box':
                        ...
                        break;
                    case 'date':
                        params = self._prepareSubmitDates(params, tquestionhis.name, this.value, false);
                        break;
                    case 'datetime':
        ...
        *   Convert date value from client current timezo_preparetextboxsubmitne to UTC Date to correspond to the server format.
